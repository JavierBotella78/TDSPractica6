...
int FMOD_Main()
{
    ...
    ERRCHECK( system->getEvent("event:/Desert Leitmotif", &eventDescription) );
    ...
    ERRCHECK( eventDescription->getParameterDescriptionByName("progreso", &paramDesc) );
    ...
    float surfaceParameterValue = 0.0f;
